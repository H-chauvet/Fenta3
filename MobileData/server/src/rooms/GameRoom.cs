...
//            addMember(pPlayer1);
//            addMember(pPlayer2);
//            //send the empty board data to the players
//            GameStart emptyBoard = new GameStart();
//            emptyBoard.player1 = _server.GetPlayerInfo(pPlayer1).playerName;
//            emptyBoard.player2 = _server.GetPlayerInfo(pPlayer2).playerName;
//            sendToAll(emptyBoard);
//        }
...
//            if (_board.GetBoardData().WhoHasWon() != 0)
//            {
//                OnGameEnd(_board.GetBoardData().WhoHasWon());
//                IsGameInPlay = false;
//            }
//        }
...
//        private void OnGameEnd(int playerWhoWon)
//        {
//            Console.WriteLine(playerWhoWon);
//            for(int i = base.memberCount; i > 0; i--)
//            {
//                TcpMessageChannel channelToRemove = base.getMember(i - 1);
//                base.removeMember(channelToRemove);
//                _server.GetLobbyRoom().AddMember(channelToRemove);
//                ChatMessage message = new ChatMessage();
//                if (i == playerWhoWon) message.message = "You win!";
//                else message.message = "You lose :(";
//                channelToRemove.SendMessage(message);
//            }
